...
Latest static validation: **198 passed checks, 0 errors, 1 environment warning**. The warning only indicates that the authoring environment has no Docker daemon for live container execution.
